...
public class DroneServiceControllerCucumberTest {
    @ClassRule
    public static EmbeddedKafkaRule rule = new EmbeddedKafkaRule(1, true, "drones", "drones-commands");
    @BeforeClass
    public static void beforeAll(){
        ...
        System.setProperty("spring.kafka.partitions-per-topics", String.valueOf(rule.getEmbeddedKafka().getPartitionsPerTopic()));
    }
