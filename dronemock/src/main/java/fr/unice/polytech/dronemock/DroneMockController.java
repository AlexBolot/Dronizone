...
public class DroneMockController {
    ...
    public void receivedCommand(String message) {
        ...
        try {
            ...
            switch (command) {
                case "INITIALISATION":
                    this.currentDrone.setDroneID(payload.asLong());
                    break;
                case "DELIVERY":
                    this.currentDelivery = new ObjectMapper().readValue(payload.toString(), Delivery.class);
                    ...
                    break;
                case "CALLBACK":
                    this.base = new ObjectMapper().readValue(payload.toString(), Location.class);
